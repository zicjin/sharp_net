...
namespace sharp_net.Mvc {
    ...
    public static partial class HtmlHelpers {
        ...
        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, bool allowMultiple) {
            return DropDownListHelper(htmlHelper, name, null, null, allowMultiple, null);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple) {
            return DropDownListHelper(htmlHelper, name, selectList, null, allowMultiple, null);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, string optionLabel, bool allowMultiple) {
            return DropDownListHelper(htmlHelper, name, null, optionLabel, allowMultiple, null);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple, IDictionary<string, object> htmlAttributes) {
            return DropDownListHelper(htmlHelper, name, selectList, null, allowMultiple, htmlAttributes);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple, object htmlAttributes) {
            return DropDownListHelper(htmlHelper, name, selectList, null, allowMultiple, new RouteValueDictionary(htmlAttributes));
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple) {
            return DropDownListHelper(htmlHelper, name, selectList, optionLabel, allowMultiple, null);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple, IDictionary<string, object> htmlAttributes) {
            return DropDownListHelper(htmlHelper, name, selectList, optionLabel, allowMultiple, htmlAttributes);
        }

        public static MvcHtmlString DropDownGropList(this HtmlHelper htmlHelper, string name, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple, object htmlAttributes) {
            return DropDownListHelper(htmlHelper, name, selectList, optionLabel, allowMultiple, new RouteValueDictionary(htmlAttributes));
        }

        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple) {
            return DropDownGroupListFor(htmlHelper, expression, selectList, null /* optionLabel */, allowMultiple, null /* htmlAttributes */);
        }

        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple, object htmlAttributes) {
        ...
        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, bool allowMultiple, IDictionary<string, object> htmlAttributes) {
            return DropDownGroupListFor(htmlHelper, expression, selectList, null /* optionLabel */, allowMultiple, htmlAttributes);
        }

        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple) {
            return DropDownGroupListFor(htmlHelper, expression, selectList, optionLabel, allowMultiple, null /* htmlAttributes */);
        }

        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple, object htmlAttributes) {
        ...
        public static MvcHtmlString DropDownGroupListFor<TModel, TProperty>(this HtmlHelper<TModel> htmlHelper, Expression<Func<TModel, TProperty>> expression, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple, IDictionary<string, object> htmlAttributes) {
            if (expression == null) {
        ...
        private static MvcHtmlString DropDownListHelper(HtmlHelper htmlHelper, string expression, IEnumerable<GroupedSelectListItem> selectList, string optionLabel, bool allowMultiple, IDictionary<string, object> htmlAttributes) {
