...
namespace zic_dotnet.Domain.Repositories.EntityFramework {
    public class EntityFrameworkRepository<TAggregateRoot> : Repository<TAggregateRoot>
        ...
        protected override IEnumerable<TAggregateRoot> DoGetAll(Specifications.ISpecification<TAggregateRoot> specification, System.Linq.Expressions.Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize) {
        ...
        protected override IEnumerable<TAggregateRoot> DoFindAll(Specifications.ISpecification<TAggregateRoot> specification, System.Linq.Expressions.Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder) {
        ...
        protected override IEnumerable<TAggregateRoot> DoFindAll(Specifications.ISpecification<TAggregateRoot> specification, System.Linq.Expressions.Expression<Func<TAggregateRoot, dynamic>> sortPredicate, SortOrder sortOrder, int pageNumber, int pageSize) {
            if (pageNumber <= 0)
        ...
        protected override TAggregateRoot DoGet(Specifications.ISpecification<TAggregateRoot> specification) {
